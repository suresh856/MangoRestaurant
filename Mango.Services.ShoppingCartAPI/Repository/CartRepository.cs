            ...
            try
            {
                ...
                else 
                {
                    ...
                    else
                    {
                        ...
                        cart.CartDetails.FirstOrDefault().CartDetailsId = cartDeatilsFromDb.CartDetailsId;
                        cart.CartDetails.FirstOrDefault().CartHeaderId = cartDeatilsFromDb.CartHeaderId;
                        cart.CartDetails.FirstOrDefault().Product = null;
